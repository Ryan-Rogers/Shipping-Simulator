...
public class OilTanker  extends Ship
{
     ...
     * @param cargo
     */
    public OilTanker(String name, String countryReg, char shipSymbol, long transponder, double capacity, double length, double beam, double draft, double longitute, double latitude, Cargo cargo) {
    ...
    */
    ...
    {
        String returnString = String.format("Tanker,%s,%s,%d,%f,%f,%f,%f,&f,&f", 
